...
import com.ourgiant.s3.browser.util.NetworkFetchException;
...
class AboutDialog extends JDialog {
    ...
    AboutDialog(Frame parent, UpdateChecker.ReleaseInfo knownNewerRelease) {
        super(parent, "About S3 Browser", knownNewerRelease == null);
    ...
    private static String buildHtml(String currentVersion) {
        return """
            ...
            <h2 style="margin-top: 0;">S3 Browser</h2>
            <p>Version %s</p>
            <p>A Java Swing desktop application for browsing AWS S3 buckets and objects,
            connecting via local AWS profiles.</p>
            <p>&copy; OurGiant</p>
            </body></html>
